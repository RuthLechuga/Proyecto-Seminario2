...
SELECT * FROM Pivote;
SELECT * FROM PRODUCTO ORDER BY CodProducto;
...
UNION (SELECT 'Sucursal', COUNT(*) FROM SUCURSAL)
UNION (SELECT 'Fecha', COUNT(*) FROM FECHA)
UNION (SELECT 'Region', COUNT(*) FROM REGION)
UNION (SELECT 'Cliente', COUNT(*) FROM CLIENTE)
UNION (SELECT 'Vendedor', COUNT(*) FROM VENDEDOR)
UNION (SELECT 'Compra', COUNT(*) FROM COMPRA)
